...
function FloatingNavbar() {
  return (
    ...
    >
      <div className="bg-black/80 backdrop-blur-md border border-white/10 rounded-full px-6 py-3 md:px-8 md:py-4 flex items-center justify-between w-full max-w-5xl shadow-[0_0_20px_rgba(0,0,0,0.5)] pointer-events-auto">
        ...
        {/* বুক এ কল বাটন (হোয়াটসঅ্যাপ লিংক সহ) */}
        <a 
          href="https://wa.me/8801400905891" 
          target="_blank" 
        ...
        <section id="about" className="py-10 scroll-mt-28">
            <div className="relative bg-gradient-to-r from-[#2a0845] to-[#6441A5] rounded-3xl p-6 md:p-10 shadow-2xl border border-white/10 overflow-hidden">
                ...
                <div className="relative z-10 grid grid-cols-1 lg:grid-cols-12 gap-8 items-center">
                    ...
                    {/* --- সোশ্যাল বাটন (আপনার লিংক আপডেট করা হয়েছে) --- */}
                    <div className="lg:col-span-1 flex flex-row lg:flex-col justify-center gap-4">
                        
                        {/* ১. ফেসবুক */}
                        <SocialButton 
                            href="https://www.facebook.com/fahiminframe" 
                            color="bg-[#1877F2]" 
                            iconPath="M14 13.5h2.5l1-4H14v-2c0-1.03 0-2 2-2h1.5V2.14c-.326-.043-1.557-.152-2.905-.152-2.81 0-4.63 1.713-4.63 4.747v2.764h-3.1v4h3.1v10.5h4.63V13.5Z" 
                        />
                        
                        {/* ২. ইনস্টাগ্রাম */}
                        <SocialButton 
                            href="https://www.instagram.com/fahim_inframe" 
                        ...
                        {/* ৩. লিংকডইন */}
                        <SocialButton 
                            href="https://www.linkedin.com/in/tanvir-kabir-fahim" 
                            color="bg-[#0077b5]" 
      ...
      <footer id="contact" className="relative z-20 bg-black pt-20 pb-10 border-t border-white/10 mt-20">
        <div className="max-w-6xl mx-auto px-6 md:px-10">
            ...
            <div className="flex flex-col md:flex-row justify-between items-center mt-16 pt-8 border-t border-white/5 text-xs text-gray-500">
                ...
                {/* Small Icons (ফুটার লিংকস) */}
                <div className="flex gap-6 mt-4 md:mt-0">
                    <a href="https://www.linkedin.com/in/tanvir-kabir-fahim" target="_blank" className="hover:text-white transition"><svg fill="currentColor" width="16" height="16" viewBox="0 0 24 24"><path d="M19 0h-14c-2.761 0-5 2.239-5 5v14c0 2.761 2.239 5 5 5h14c2.762 0 5-2.239 5-5v-14c0-2.761-2.238-5-5-5zm-11 19h-3v-11h3v11zm-1.5-12.268c-.966 0-1.75-.79-1.75-1.764s.784-1.764 1.75-1.764 1.75.79 1.75 1.764-.783 1.764-1.75 1.764zm13.5 12.268h-3v-5.604c0-3.368-4-3.113-4 0v5.604h-3v-11h3v1.765c1.396-2.586 7-2.777 7 2.476v6.759z"/></svg></a>
                    <a href="https://www.facebook.com/fahiminframe" target="_blank" className="hover:text-white transition"><svg fill="currentColor" width="16" height="16" viewBox="0 0 24 24"><path d="M18.244 2.25h3.308l-7.227 8.26 8.502 11.24H16.17l-5.214-6.817L4.99 21.75H1.68l7.73-8.835L1.254 2.25H8.08l4.713 6.231zm-1.161 17.52h1.833L7.084 4.126H5.117z"/></svg></a>
                    <a href="https://www.instagram.com/fahim_inframe" target="_blank" className="hover:text-white transition"><svg fill="currentColor" width="16" height="16" viewBox="0 0 24 24"><path d="M9 8h-3v4h3v12h5v-12h3.642l.358-4h-4v-1.667c0-.955.192-1.333 1.115-1.333h2.885v-5h-3.808c-3.596 0-5.192 1.583-5.192 4.615v3.385z"/></svg></a>
                </div>
            </div>
